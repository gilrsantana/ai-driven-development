...
## Metadata
- **ID**: RULE-010-TESTING
- **Scope**: {ProjectName}.UnitTests & {ProjectName}.IntegrationTests
...
```csharp
using Moq;
using {ProjectName}.Application.UseCases.Posts.CommandHandlers;
using {ProjectName}.Application.UseCases.Posts.Commands;
