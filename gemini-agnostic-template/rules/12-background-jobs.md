...
- **Location**: `src/{ProjectName}.Application/ApplicationJobs/`
- **Namespace**: `{ProjectName}.Application.ApplicationJobs`
...
- **Dependencies**: Inject repositories, services, and `IUnitOfWork` using the standard constructor injection pattern. Do not reference `{ProjectName}DbContext` directly.
