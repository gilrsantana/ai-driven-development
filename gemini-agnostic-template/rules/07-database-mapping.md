...
- **Scope**: {ProjectName}.Infrastructure
...
- **Class Naming**: Use the suffix `DbContext` (e.g., `{ProjectName}DbContext`).
    ...
    where TEntity : BaseEntity
{
    ...
    protected BaseEntityRepository({ProjectName}DbContext context)
    {
        Context = context;
