...
- Create your test class in the `{ProjectName}.UnitTests` project.
...
```csharp
using Moq;
using {ProjectName}.Application.UseCases.Users.CommandHandlers;
using {ProjectName}.Application.UseCases.Users.Commands;
